...
window.UI = (function () {
  ...
  const LANG_KEY = "sap_lang";
      ...
      "Build your store.<br>Edit it live.": "Mağazanızı kurun.<br>Canlı düzenleyin.",
      "Build your store. Edit it live.": "Mağazanızı kurun. Canlı düzenleyin.",
      ...
      "By continuing, you acknowledge WeboCloud's Privacy Policy.": "Devam ederek WeboCloud'un Privacy Policy'sini kabul etmiş olursunuz.",
      ...
      "WeboCloud turns invoices, orders, stock and ledgers into one live console — searchable, shareable and always up to date.": "WeboCloud faturaları, siparişleri, stoğu ve defterleri tek bir canlı konsola dönüştürür — aranabilir, paylaşılabilir ve her zaman güncel.",
    ...
    ar: {
      ...
      "Build your store.<br>Edit it live.": "أنشئ متجرك.<br>عدّله مباشرة.",
      "Build your store. Edit it live.": "أنشئ متجرك. عدّله مباشرة.",
      ...
      "By continuing, you acknowledge WeboCloud's Privacy Policy.": "بالمتابعة، فإنك توافق على سياسة الخصوصية لـ WeboCloud.",
      "New company?": "شركة جديدة؟",
      "Create your workspace": "أنشئ مساحة عملك",
      "Take your business off paper.": "انقل أعمالك بعيداً عن الورق.",
      "WeboCloud turns invoices, orders, stock and ledgers into one live console — searchable, shareable and always up to date.": "تُحوّل ويبوسحاب الفواتير، والطلبات، والمخزون، والدفاتر إلى وحدة تحكم واحدة مباشرة — قابلة للبحث، والمشاركة، ومحدثة باستمرار.",
