...
window.UI = (function () {
  ...
  const TRANSLATIONS = {
    tr: {
      ...
      "Owner account": "Kurucu hesabı",
      "Owner name": "Kurucu adı",
      "Owner email": "Kurucu e-postası",
      "Database hosting": "Veritabanı barındırma",
      "Initial team members": "İlk ekip üyeleri",
      "Add team member": "Ekip üyesi ekle",
      "Already have a workspace?": "Zaten çalışma alanınız var mı?",
      "Plan prices": "Plan Fiyatları",
      "Start free, upgrade when you're ready. Every plan keeps your data exactly where it is — no rebuild, no migration.": "Ücretsiz başlayın, hazır olduğunuzda yükseltin. Tüm planlar verilerinizi korur — yeniden kurulum gerekmez.",
      "Frequently Asked Questions": "Sıkça Sorulan Sorular",
      "Can I switch plans later?": "Daha sonra plan değiştirebilir miyim?",
      "Yes, you can upgrade, downgrade, or cancel your subscription at any time directly from your console settings. Changes apply immediately.": "Evet, aboneliğinizi konsol ayarlarından dilediğiniz zaman yükseltebilir, düşürebilir veya iptal edebilirsiniz.",
      "Ready to get started?": "Başlamaya hazır mısınız?",
      "Everything you need to run your business — orders, inventory, team and finance in one place.": "İşinizi yönetmek için ihtiyacınız olan her şey — siparişler, envanter, ekip ve finans tek bir yerde.",
      "Start free": "Ücretsiz Başla",
      "Platform": "Platform",
      "Solutions": "Çözümler",
      "Pricing": "Fiyatlandırma",
      "Resources": "Kaynaklar",
      "By industry": "Sektöre göre",
      "Operations console": "Operasyon Konsolu",
      "Dashboard, orders, stock & finance": "Kontrol paneli, siparişler, stok ve finans",
      "Souqi": "Souqi",
      "Create workspace": "Çalışma alanı oluştur",
      "Website builder": "Web Sitesi Oluşturucu",
      "A branded storefront in minutes": "Dakikalar içinde markalı bir mağaza",
      "AI Accountant": "YZ Muhasebeci",
      "Finance insights, on tap": "Anında finansal analizler",
      "Audit history": "Denetim Geçmişi",
      "Every action, logged": "Her işlem kayıt altında",
      "Individual": "Bireysel",
      "Free, Pro & Max plans": "Ücretsiz, Pro ve Max planları",
      "Team & Enterprise": "Ekip ve Kurumsal",
      "Multi-user teams & offices": "Çok kullanıcılı ekipler ve ofisler",
      "Build your website.<br>Edit it live.": "Web sitenizi kurun.<br>Canlı düzenleyin.",
      "Build your website. Edit it live.": "Web sitenizi kurun. Canlı düzenleyin.",
      "Create your website in minutes, then change anything by clicking it — no code.": "Dakikalar içinde web sitenizi oluşturun, ardından tıklayarak her şeyi değiştirin — kod yazmadan.",
      "Continue with Google": "Google ile Devam Et",
      "OR": "VEYA",
      "Enter your email": "E-postanızı girin",
      "Continue with email": "E-posta ile Devam Et",
      "By continuing, you acknowledge Souqi's Privacy Policy.": "Devam ederek Souqi'nin Gizlilik Politikası'nı kabul etmiş olursunuz.",
      "New company?": "Yeni şirket mi?",
      "Create your workspace": "Çalışma alanınızı oluşturun",
      "Take your business off paper.": "İşinizi kâğıttan dijitale taşıyın.",
      "Souqi turns invoices, orders, stock and ledgers into one live console — searchable, shareable and always up to date.": "Souqi faturaları, siparişleri, stoğu ve defterleri tek bir canlı konsola dönüştürür — aranabilir, paylaşılabilir ve her zaman güncel.",
      "Staff and customers each pick their own language in a click — with full right-to-left support built in.": "Personel ve müşteriler tek tıkla kendi dillerini seçebilir — tam sağdan sola (RTL) desteği dahil.",
      ...
      "Türkçe": "Türkçe",
      "العربية": "العربية",
      "8 industries you choose from": "Seçebileceğiniz 8 sektör",
      "Explore ": "Keşfet ",
      "Logistics & Trade": "Lojistik ve Ticaret",
      "freight": "kargo",
      "Freight, customs and fleet — tracked end to end.": "Kargo, gümrük ve filo — uçtan uca takip edildi.",
      "Freight, fully tracked.": "Kargo, tam takipli.",
      "Container 20ft": "Konteyner 20ft",
      "Pallet Ship": "Palet Gönderimi",
      "Express Air": "Hızlı Hava Kargo",
      "Fashion & Apparel": "Moda ve Giyim",
      "atelier": "atölye",
      "Collections, sizes and seasons that sell themselves.": "Kendi kendini satan koleksiyonlar, bedenler ve sezonlar.",
      "New season, now live.": "Yeni sezon yayında.",
      "Linen Blazer": "Keten Ceket",
      "Silk Dress": "İpek Elbise",
      "Suede Boots": "Süet Bot",
      "Wholesale & Distribution": "Toptan ve Dağıtım",
      "depot": "depo",
      "Bulk orders, price tiers and B2B — handled with ease.": "Toplu siparişler, fiyat kademeleri ve B2B — kolaylıkla yönetilir.",
      "Bulk, priced to move.": "Toplu satış, uygun fiyatlı.",
      "Rice 25kg": "Pirinç 25kg",
      "Sugar 50kg": "Şeker 50kg",
      "Flour Pallet": "Un Paleti",
      "Retail Superstore": "Perakende Hipermarket",
      "market": "market",
      "Aisles of stock, one live shelf count.": "Stok reyonları, tek bir canlı raf sayımı.",
      "Everything, in stock.": "Her şey stokta.",
      "Cola 6-pack": "Kola 6'lı",
      "Olive Oil 1L": "Zeytinyağı 1L",
      "Detergent": "Deterjan",
      "Manufacturing": "Üretim",
      "works": "fabrika",
      "Raw parts to finished product, right on schedule.": "Hammadde'den bitmiş ürüne, tam zamanında.",
      "Parts to product.": "Parçadan ürüne.",
      "Bearing Set": "Rulman Seti",
      "Alloy Sheet": "Alaşımlı Sac",
      "Motor Unit": "Motor Ünitesi",
      "Restaurant": "Restoran",
      "bistro": "bistro",
      "Menu, kitchen and tables in one smooth flow.": "Menü, mutfak ve masalar tek bir akıcı döngüde.",
      "Order fresh, served fast.": "Taze sipariş, hızlı servis.",
      "Margherita": "Margherita",
      "Beef Burger": "Et Burger",
      "Garden Salad": "Mevsim Salata",
      "Construction": "İnşaat",
      "buildco": "insaatas",
      "Sites, materials and crews — all accounted for.": "Şantiyeler, malzemeler ve ekipler — hepsi hesaba katıldı.",
      "Materials, on schedule.": "Malzemeler zamanında.",
      "Cement 50kg": "Çimento 50kg",
      "Steel Pipe": "Çelik Boru",
      "Power Drill": "Matkap",
      "Professional Services": "Profesyonel Hizmetler",
      "studio": "studyo",
      "Book, bill and deliver every engagement.": "Her işi rezerve edin, faturalandırın ve teslim edin.",
      "Book, bill, deliver.": "Rezerve et, faturalandır, teslim et.",
      "Consulting hr": "Danışmanlık saati",
      "Design Package": "Tasarım Paketi",
      "Retainer": "Aylık Danışmanlık"
    ,
      "demo.souqi.site": "demo.souqi.site",
      "building…": "oluşturuluyor…",
      "Watch your website build itself…": "Web sitenizin kendi kendini oluşturmasını izleyin…",
      "demo": "demo",
      "Cart": "Sepet",
      "STOREFRONT": "MAĞAZA",
      ...
      "$89": "$89",
      "Total": "Toplam",
      "Pay with": "Şununla öde",
      "Pay $260": "260$ Öde",
      "Creating your site…": "Siteniz oluşturuluyor…",
      "✓ Site created": "✓ Site oluşturuldu",
      "Applying the Retail template…": "Perakende şablonu uygulanıyor…",
      "✓ Template applied": "✓ Şablon uygulandı",
      "Adding products…": "Ürünler ekleniyor…",
      "✓ 3 products added": "✓ 3 ürün eklendi",
      "Editing the hero text…": "Ana metin düzenleniyor…",
      "✓ Hero updated": "✓ Ana metin güncellendi",
      "Switching theme → teal…": "Temaya geçiliyor → turkuaz…",
      "✓ Theme changed": "✓ Tema değiştirildi",
      "Publishing…": "Yayınlanıyor…",
      "Cart · 2": "Sepet · 2",
      "live": "yayında",
      "✓ Published — live now": "✓ Yayınlandı — şu an yayında",
      "A customer is checking out…": "Bir müşteri ödeme yapıyor…",
      "✓ Paid": "✓ Ödendi",
      "✓ Order paid · Visa •••• 4242": "✓ Sipariş ödendi · Visa •••• 4242",
      "Built with Souqi": "Souqi ile oluşturuldu",

      /* ---- build.html (prompt-first home) ---- */
      "Orders, stock, finance, shipments": "Siparişler, stok, finans, sevkiyat",
      "Storefront builder": "Mağaza oluşturucu",
      "Click anything to edit it": "Değiştirmek için üzerine tıklayın",
      "AI assistant": "Yapay zekâ asistanı",
      "Ask your data in plain language": "Verilerinize günlük dille soru sorun",
      "Retail & Fashion": "Perakende ve Moda",
      "Restaurants & Services": "Restoran ve Hizmetler",
      "Agent": "Ajan",
      "What will you build?": "Ne inşa edeceksiniz?",
      "Describe your business in one sentence. Your first build is free — no card needed.": "İşinizi tek cümleyle anlatın. İlk kurulumunuz ücretsiz — kart gerekmez.",
      "Start": "Başla",
      "Website": "Web sitesi",
      "Storefront": "Mağaza",
      "Catalog": "Katalog",
      ...
      "Try an example prompt": "Örnek bir istem deneyin",
      "Built for": "Şunlar için",
      "Meet the <em>Souqi Agent</em>": "<em>Souqi Ajanı</em> ile tanışın",
      "Your business, running on one sentence.": "İşiniz, tek bir cümleyle çalışıyor.",
      "Live editor": "Canlı düzenleyici",
      "Design Freely": "Özgürce Tasarlayın",
      "Click any section, heading, price or photo and change it right on the page. What you see is exactly what your customers get.": "Herhangi bir bölüme, başlığa, fiyata veya fotoğrafa tıklayın ve doğrudan sayfa üzerinde değiştirin. Gördüğünüz, müşterilerinizin gördüğüyle birebir aynıdır.",
      "Staged builds": "Aşamalı kurulum",
      "Move faster": "Daha hızlı ilerleyin",
      "The Agent plans, writes and assembles your pages in parallel — and shows you every step as it happens.": "Ajan sayfalarınızı paralel olarak planlar, yazar ve birleştirir — her adımı olurken görürsünüz.",
      "One workspace": "Tek çalışma alanı",
      "Ship Anything": "Her Şeyi Yayınlayın",
      "Storefront, catalog, orders, invoices and shipments in one project — with one design and no context switching.": "Mağaza, katalog, siparişler, faturalar ve sevkiyat tek bir projede — tek bir tasarımla, dağılmadan.",
      "Roles & permissions": "Roller ve yetkiler",
      "Build together": "Birlikte inşa edin",
      "Invite your team with the right role — owner, manager, staff. Everyone works on the same live data, and every change is on the audit trail.": "Ekibinizi doğru rolle davet edin — sahip, yönetici, personel. Herkes aynı canlı veriyle çalışır ve her değişiklik denetim kaydına işlenir.",
      "Powered by the Souqi platform": "Souqi platformuyla güçlendirildi",
      "Agent chat": "Ajan sohbeti",
      "Describe It.<br>Publish It.": "Anlatın.<br>Yayınlayın.",
      "Describe your business and publish it. The Agent builds a real storefront, keeps improving it, and stays out of your way.": "İşinizi anlatın ve yayınlayın. Ajan gerçek bir mağaza kurar, geliştirmeye devam eder ve yolunuzdan çekilir.",
      "Full-stack infrastructure": "Uçtan uca altyapı",
      "Build & Scale<br>Your Store.": "Mağazanızı Kurun<br>ve Büyütün.",
      "Built-in from day one — accounts, your own database, hosting, and a full audit log. No servers to wire up.": "İlk günden hazır — hesaplar, kendi veritabanınız, barındırma ve tam denetim kaydı. Kurulacak sunucu yok.",
      "Integrations": "Entegrasyonlar",
      "Connect To AI<br>& Services.": "Yapay Zekâ ve<br>Servislere Bağlanın.",
      "Payments, QR checkout, WhatsApp orders and a Gemini-powered assistant that answers questions about your own data.": "Ödemeler, QR ile ödeme, WhatsApp siparişleri ve kendi verilerinizle ilgili soruları yanıtlayan Gemini destekli asistan.",
      "Control": "Kontrol",
      "Secure Your Data<br>As You Scale.": "Büyürken Verinizi<br>Güvende Tutun.",
      "Per-workspace isolation, hashed passwords, signed sessions and role-based access. Your data never mixes with anyone else's.": "Çalışma alanı bazında izolasyon, şifrelenmiş parolalar, imzalı oturumlar ve rol bazlı erişim. Verileriniz asla başkasınınkiyle karışmaz.",
      "Trusted by builders": "Kuranların tercihi",
      "Sample quotes — replace before launch": "Örnek yorumlar — yayına almadan önce değiştirin",
      "Next<br>testimonial": "Sonraki<br>yorum",
      "Previous<br>testimonial": "Önceki<br>yorum",
      "What are you waiting for?": "Daha ne bekliyorsunuz?",
    ...
    ar: {
      ...
      "Database hosting": "استضافة قاعدة البيانات",
      "Initial team members": "أعضاء الفريق الأوليين",
      "Add team member": "إضافة عضو فريق",
      "Already have a workspace?": "هل لديك مساحة عمل بالفعل؟",
      "Plan prices": "أسعار الخطط",
      "Start free, upgrade when you're ready. Every plan keeps your data exactly where it is — no rebuild, no migration.": "ابدأ مجاناً وترقى عندما تكون جاهزاً. كل خطة تحفظ بياناتك تماماً كما هي — بدون إعادة بناء أو نقل.",
      "Frequently Asked Questions": "الأسئلة الشائعة",
      "Can I switch plans later?": "هل يمكنني تغيير الخطة لاحقاً؟",
      "Yes, you can upgrade, downgrade, or cancel your subscription at any time directly from your console settings. Changes apply immediately.": "نعم، يمكنك الترقية أو تخفيض الخطة أو إلغاء الاشتراك في أي وقت مباشرة من إعدادات المنصة.",
      "Ready to get started?": "هل أنت جاهز للبدء؟",
      "Everything you need to run your business — orders, inventory, team and finance in one place.": "كل ما تحتاجه لإدارة أعمالك — الطلبات، المخزون، الفريق والمالية في مكان واحد.",
      ...
      "Operations console": "وحدة تحكم العمليات",
      "Dashboard, orders, stock & finance": "لوحة التحكم، الطلبات، المخزون والمالية",
      "Souqi": "سوقي",
      "Create workspace": "إنشاء مساحة عمل",
      "Website builder": "منشئ المواقع",
      "A branded storefront in minutes": "متجر يحمل علامتك التجارية في دقائق",
      "AI Accountant": "محاسب الذكاء الاصطناعي",
      "Finance insights, on tap": "تحليلات مالية فورية",
      "Audit history": "سجل التدقيق",
      "Every action, logged": "كل إجراء مسجل وموثق",
      "Individual": "فردي",
      "Free, Pro & Max plans": "الخطط المجانية والاحترافية والقصوى",
      "Team & Enterprise": "الفريق والمؤسسات",
      "Multi-user teams & offices": "فرق ومكاتب متعددة المستخدمين",
      "Build your website.<br>Edit it live.": "أنشئ موقعك الإلكتروني.<br>عدّله مباشرة.",
      "Build your website. Edit it live.": "أنشئ موقعك الإلكتروني. عدّله مباشرة.",
      "Create your website in minutes, then change anything by clicking it — no code.": "أنشئ موقعك الإلكتروني في دقائق، ثم عدّل أي شيء بالنقر عليه — بدون برمجة.",
      "Continue with Google": "المتابعة باستخدام Google",
      "OR": "أو",
      "Enter your email": "أدخل بريدك الإلكتروني",
      "Continue with email": "المتابعة بالبريد الإلكتروني",
      "By continuing, you acknowledge Souqi's Privacy Policy.": "بالمتابعة، فإنك توافق على سياسة الخصوصية لـ سوقي.",
      "New company?": "شركة جديدة؟",
      "Create your workspace": "أنشئ مساحة عملك",
      "Take your business off paper.": "انقل أعمالك بعيداً عن الورق.",
      "Souqi turns invoices, orders, stock and ledgers into one live console — searchable, shareable and always up to date.": "تُحوّل سوقي الفواتير، والطلبات، والمخزون، والدفاتر إلى وحدة تحكم واحدة مباشرة — قابلة للبحث، والمشاركة، ومحدثة باستمرار.",
      "Staff and customers each pick their own language in a click — with full right-to-left support built in.": "يمكن للموظفين والعملاء اختيار لغتهم بضغطة زر واحدة — مع دعم كامل للكتابة من اليمين إلى اليسار (RTL).",
      "Sign in — MERVEKS SAP": "تسجيل الدخول — مرڤكس SAP",
      "SAP Console": "وحدة تحكم SAP",
      "Move trade<br>with total<br>confidence.": "أدر تجارتك<br>بثقة مطلقة<br>وأمان تام.",
      "Move trade<br />with total<br />confidence.": "أدر تجارتك<br />بثقة مطلقة<br />وأمان تام.",
      "Railway, food supply, Nano-Z Coating distribution and procurement — one console, full visibility and a complete history of every action. Built on a single motto: <b style=\"color:#fff\">trust</b>.": "السكك الحديدية، التغذية، توزيع طبقات Nano-Z والمشتريات — منصة واحدة، رؤية كاملة وسجل شامل لكل عمل. قائمة على مبدأ واحد: <b style=\"color:#fff\">الثقة</b>.",
      "Established": "تأسست",
      "Hubs · TR": "المراكز · تركيا",
      "Per wagon": "لكل عربة",
      "Service lines": "خطوط الخدمة",
      "Welcome back": "أهلاً بك مجدداً",
      "Sign in to the MERVEKS operations console.": "سجل الدخول إلى وحدة تحكم العمليات مرڤكس.",
      "Email": "البريد الإلكتروني",
      "Password": "كلمة المرور",
      "Sign in to console": "تسجيل الدخول إلى المنصة",
      "Owner": "المالك / المؤسس",
      "Employee": "الموظف",
      "Also: ": "أيضاً: ",
      "Invalid email or password. Try the demo credentials below.": "البريد الإلكتروني أو كلمة المرور غير صحيحة. جرب بيانات العرض التجريبي أدناه.",
      "Mersin": "مرسين",
      "Istanbul": "إسطنبول",
      "Moscow": "موسكو",
      "Baku": "باكو",
      "Tehran": "طهران",
      "© 2013–2026 MERVEKS · Mersin & Istanbul, Türkiye": "© 2013–2026 مرڤكس · مرسين وإسطنبول، تركيا",
      "Main": "القائمة الرئيسية",
      "Operations": "العمليات",
      "Network": "الشبكة والشركاء",
      "System": "النظام",
      "Dashboard": "لوحة التحكم",
      "Operations overview": "نظرة عامة على العمليات",
      "Deliveries": "التسليمات",
      "Fulfilment & carriers": "التنفيذ وشركات النقل",
      "Outbound logistics": "الخدمات اللوجستية الصادرة",
      "Customers": "العملاء",
      "Buyer accounts": "حسابات المشترين",
      "Products": "المنتجات",
      "Catalogue & stock": "الكتالوج والمخزون",
      "Vendors": "الموردون",
      "Supply partners": "شركاء التوريد",
      "Replenishment partners": "شركاء إعادة التزويد",
      "Buyers": "المشترون",
      "Trade accounts": "الحسابات التجارية",
      "Sales": "المبيعات",
      "Counter & online sales": "المبيعات المباشرة عبر الإنترنت",
      "Stock": "المخزون",
      "Shelf & back-store stock": "مخزون الرفوف والمستودع",
      "Store orders": "طلبات المتجر",
      "Restock Orders": "طلبات إعادة التزويد",
      "Inbound purchasing": "المشتريات الواردة",
      "Revenue & Invoices": "الإيرادات والفواتير",
      "Receivables": "الذمم المدينة",
      "Price Offers": "عروض الأسعار",
      "Trade quotations": "العروض التجارية",
      "Stock Orders": "طلبات المخزون",
      ...
      "Central DC": "المستودع المركزي",
      "LIVE SALES": "مبيعات مباشرة",
      "Raw": "خام",
      "Press": "كبس / تصنيع",
      "Finished": "مكتمل",
      "Kitchen": "المطبخ",
      ...
      "Work orders & runs": "أوامر العمل والتشغيل",
      "Industrial buyers": "المشترون الصناعيون",
      "Materials & Goods": "المواد والبضائع",
      "Raw materials & finished stock": "المواد الخام والمخزون النهائي",
      "Dispatch": "الإرسال والشحن",
      "Outbound freight": "الشحن الصادر",
      "Raw-material partners": "شركاء المواد الخام",
      "Material Orders": "طلبات المواد",
      "Raw-material procurement": "شراء المواد الخام",
      "Guests": "الضيوف",
      "Guests & catering clients": "الضيوف وعملاء التموين",
      "Menu & Stock": "القائمة والمخزون",
      "Ingredients & menu items": "المكونات وعناصر القائمة",
      "Produce & beverage partners": "شركاء المنتجات والمشروبات",
      "Supply Orders": "طلبات التوريد",
      "Kitchen procurement": "مشتريات المطبخ",
      "Table & online orders": "طلبات الطاولة وعبر الإنترنت",
      "Tenders": "المناقصات",
      "Bids & estimates": "العطاءات التقديرية",
      "Projects": "المشاريع",
      "Active projects": "المشاريع النشطة",
      "Developers & owners": "المطورون والمالكون",
      "Materials": "المواد",
      "Site materials & equipment": "مواد ومعدات الموقع",
      "Site Deliveries": "تسليمات الموقع",
      "Material logistics": "لوجستيات المواد",
      "Material & equipment partners": "شركاء المواد والمعدات",
      "Site procurement": "مشتريات الموقع",
      "Proposals": "المقترحات",
      "Scopes & estimates": "النطاق والتقديرات",
      "Engagements": "المشاريع والتعاقدات",
      "Client accounts": "حسابات العملاء",
      "Billing & Invoices": "الفوترة والفواتير",
      "Heavy Haul": "نقل ثقيل",
      "Crane Lift": "رفع بالرافعة",
      "Remote": "عن بُعد",
      "On-site": "في الموقع",
      "Shipments": "الشحنات",
      "Logistics & freight": "اللوجستيات والشحن",
      "Inventory": "المخزون",
      ...
      "Suppliers": "الموردون",
      "Procurement partners": "شركاء التوريد",
      "Finance & Invoices": "المالية والفواتير",
      "Finance": "المالية",
      "Invoices & receivables": "الفواتير والذمم المدينة",
      "Activity History": "سجل النشاطات",
      "Audit trail": "سجل التدقيق",
      "Team & Accounts": "الفريق والحسابات",
      "Owner & employee access": "صلاحيات المالك والموظفين",
      "Settings": "الإعدادات",
      "System & connection": "النظام والاتصال",
      "Visit merveks.com": "زيارة merveks.com",
      ...
      "Open My Work": "فتح مهامي",
      "My Work": "مهامي",
      "Your tasks & handoffs": "مهامك والتسليمات",
      "Good morning": "صباح الخير",
      "Good afternoon": "مساء الخير",
      "Good evening": "مساء الخير",
      "Here is what needs you today.": "إليك ما يحتاج متابعتك اليوم.",
      "Overdue / urgent": "متأخر / عاجل",
      "Waiting on you": "بانتظار موافقتك",
      "Heads-up": "تنبيه هام",
      "Nothing urgent — you're on top of it.": "لا يوجد شيء عاجل — كل الأمور تحت السيطرة.",
      "No open handoffs. Nice and clear.": "لا توجد تسليمات معلقة. مكتمل ونظيف.",
      "No new updates.": "لا توجد تحديثات جديدة.",
      "Open": "فتح", "Reply": "رد", "View": "عرض", "Chase": "متابعة", "Resolve": "حل", "Reorder": "إعادة طلب",
      "Assigned to you": "مُسند إليك",
      "low stock": "مخزون منخفض", "in stock": "متوفر بالمخزون", "reorder at": "حد إعادة الطلب", "chase the client": "تذكير العميل",
      "book shipment": "حجز شحنة",
      "Shipment": "شحنة", "Order": "طلب", "Invoice": "فاتورة", "Quote": "عرض سعر",
      "delivered": "تم التسليم", "issue the invoice.": "إصدار الفاتورة.",
      "Ready to invoice": "جاهز للفوترة", "New order to book": "طلب جديد بالحجز", "Invoice to collect": "فاتورة للتحصيل",
      "New supplier bill": "فاتورة مورد جديدة", "Invoice paid": "تم دفع الفاتورة", "fully paid": "مدفوعة بالكامل",
      "handed to": "تم تسليمها إلى", "create the shipment.": "إنشاء الشحنة.",
      "send it and follow up payment.": "إرسالها ومتابعة الدفع.", "schedule payment.": "جدولة الدفع.",
      "MENU": "القائمة",
      "Search…": "بحث…",
      ...
      "No records match your filter.": "لا توجد سجلات تطابق الفلتر.",
      "active shipments": "شحنات نشطة",
      "open orders": "طلبات مفتوحة",
      "receivable": "ذمم مدينة",
      "We move trade with one motto — <b>trust</b>.": "ندير التجارة بشعار واحد — <b>الثقة</b>.",
      "Active shipments": "الشحنات النشطة",
      "on rail": "على السكة الحديدية",
      "Open orders": "الطلبات المفتوحة",
      "total": "الإجمالي",
      "Inventory value (est.)": "قيمة المخزون (تقديرية)",
      "low": "منخفض",
      "Outstanding receivables": "الذمم المدينة المستحقة",
      "overdue": "متأخرة",
      "Revenue trend": "اتجاه الإيرادات",
      "Last 8 weeks · k USD": "آخر 8 أسابيع · ألف دولار",
      "Shipments in transit": "شحنات قيد النقل",
      "View all": "عرض الكل",
      "Reference": "المرجع",
      "Client": "العميل",
      "Route": "المسار",
      ...
      "No active shipments.": "لا توجد شحنات نشطة حالياً.",
      "Service mix": "توزيع الخدمات",
      "By transport mode": "حسب طريقة النقل",
      "shipments": "شحنات",
      "Low-stock alerts": "تنبيهات المخزون المنخفض",
      "items": "عناصر",
      "All products above reorder level. ✓": "جميع المنتجات أعلى من حد إعادة الطلب. ✓",
      "Recent activity": "النشاط الحديث",
      "History": "السجل",
      "Logistics & Shipments": "اللوجستيات والشحنات",
      "Railway container, road and sea freight · up to 28 t per booking": "حاويات سكة حديدية، شحن بري وبحري · حتى 28 طن لكل حجز",
      "No shipments in this status.": "لا توجد شحنات بهذه الحالة.",
      "Mode": "وسيلة النقل",
      "Load": "الحمولة",
      "ctr": "حاوية",
      "Post tracking update": "إضافة تحديث تتبع",
      "Location": "الموقع",
      "e.g. Tbilisi, GE": "مثال: تبليسي، جورجيا",
      "Note": "ملاحظة",
      "What happened?": "ماذا حدث؟",
      "Post update": "نشر التحديث",
      "Read-only — your role can't post tracking updates.": "قراءة فقط — دورك لا يسمح بنشر تحديثات التتبع.",
      "Origin": "المصدر",
      "Destination": "الوجهة",
      "Containers": "الحاويات",
      "Weight": "الوزن",
      "tonnes": "طن",
      "Departed": "تاريخ المغادرة",
      "Documents": "المستندات",
      "Tracking history": "سجل التتبع",
      "No tracking events yet.": "لا توجد تحديثات تتبع بعد.",
      "Close": "إغلاق",
      "Edit shipment": "تعديل الشحنة",
      "New shipment form title": "شحنة جديدة",
      "Weight (t)": "الوزن (طن)",
      "Departed date": "تاريخ المغادرة",
      ...
      "Delete": "حذف",
      "Inventory & Products": "المخزون والمنتجات",
      "Nano-Z Coating distribution & food supply stock across warehouses": "توزيع طلاء Nano-Z ومخزون المواد الغذائية عبر المستودعات",
      "Product": "المنتج",
      "Warehouse": "المستودع",
      ...
      "Stock on hand": "المخزون الحالي",
      "Reorder level": "حد إعادة الطلب",
      "Unit": "الوحدة",
      "Currency": "العملة",
      "Add product": "إضافة منتج",
      "Delete product?": "حذف المنتج؟",
      "Multinational accounts served by MERVEKS supply-chain operations": "حسابات متعددة الجنسيات تخدمها عمليات مرڤكس لسلسلة التوريد",
      "Country": "الدولة",
      "Sector": "القطاع",
      "Primary contact": "جهات الاتصال الرئيسية",
      "Rating": "التقييم",
      ...
      "Create client": "إنشاء حساب عميل",
      "Delete client?": "حذف العميل؟",
      "Suppliers": "الموردون",
      "Procurement & sourcing partners for distribution and technical consulting": "شركاء الشراء والتوريد للتوزيع والاستشارات الفنية",
      "Contact": "جهة الاتصال",
      "No suppliers yet.": "لا يوجد موردون بعد.",
      "Edit supplier": "تعديل المورد",
      "Supplier name": "اسم المورد",
      "Create supplier": "إضافة مورد",
      "Delete supplier?": "حذف المورد؟",
      "Orders": "الطلبات",
      "Purchase orders across distribution & supply lines": "أوامر الشراء عبر خطوط التوزيع والتوريد",
      "Order ref": "مرجع الطلب",
      "Items": "العناصر",
      "No orders in this status.": "لا توجد طلبات بهذه الحالة.",
      "Order": "الطلب",
      "Line items": "عناصر الطلب",
      "Qty": "الكمية",
      "Price": "السعر",
      "Sub": "المجموع الفرعي",
      "Advance status": "تحديث الحالة",
      "Create order": "إنشاء طلب",
      "Delete order?": "حذف الطلب؟",
      "Finance & Invoices": "المالية والفواتير",
      "Receivables across all service lines": "الذمم المدينة عبر جميع خطوط الخدمة",
      "Collected (paid)": "المحصل (المدفوع)",
      "Outstanding": "الذمم المعلقة",
      "Overdue": "المتأخرة",
      "Invoice": "الفاتورة",
      "Issued": "تاريخ الإصدار",
      "Due": "تاريخ الاستحقاق",
      "Amount": "المبلغ",
      "No invoices in this status.": "لا توجد فواتير بهذه الحالة.",
      "AI Accountant": "محاسب الذكاء الاصطناعي",
      "Receivables analysis": "تحليل الذمم المدينة",
      "Powered by Google Gemini": "مدعوم بواسطة Google Gemini",
      "Offline analysis engine · add a Gemini key in Settings for live AI": "محرك التحليل الأوفلاين · أضف مفتاح Gemini في الإعدادات للذكاء الاصطناعي المباشر",
      "Re-run": "إعادة التشغيل",
      "Assessing invoice…": "تقييم الفاتورة…",
      "Edit invoice": "تعديل الفاتورة",
      "Invoice no.": "رقم الفاتورة",
      "Create invoice": "إنشاء فاتورة",
      "Delete invoice?": "حذف الفاتورة؟",
      "Audit trail of all console creations, edits and deletions": "سجل تدقيق لجميع عمليات الإنشاء والتعديل والحذف",
      "Action": "الإجراء",
      "Actor": "المنفذ",
      "Target": "الهدف",
      "Summary": "الملخص",
      "Time": "الوقت",
      "No audit records found.": "لا توجد سجلات تدقيق.",
      "Owner and employee accounts · roles control what each person can access": "حسابات المالك والموظفين · الأدوار تحدد صلاحيات كل شخص",
      "Member": "العضو",
      "Department": "القسم",
      ...
      "Role": "الدور",
      "Active status": "حالة الحساب",
      "Create employee": "إضافة موظف",
      "Delete employee?": "حذف الموظف؟",
      "Backend connection": "اتصال خادم الخلفية",
      "Connection base URL": "رابط الاتصال الرئيسي",
      "Save settings": "حفظ الإعدادات",
      "Disconnect (demo mode)": "قطع الاتصال (وضع العرض)",
      "AI Accounting (Gemini)": "المحاسبة بالذكاء الاصطناعي (Gemini)",
      "Gemini API key": "مفتاح Gemini API",
      "Save API key": "حفظ المفتاح",
      "Use offline engine": "استخدام المحرك الأوفلاين",
      "Team & access": "الفريق والصلاحيات",
      "Your role": "دورك الحالي",
      "Company & data": "الشركة والبيانات",
      "Company": "الشركة",
      "Reset demo data": "إعادة ضبط البيانات التجريبية",
      "Reset demo data?": "إعادة ضبط البيانات؟",
      "Reset": "إعادة ضبط",
      "Manage team": "إدارة الفريق",
      "Select language": "اختر اللغة",
      "Language": "اللغة",
      "Emin misiniz?": "هل أنت تأكد؟",
      "Are you sure?": "هل أنت تأكد؟",
      "Cancel": "إلغاء",
      "Confirm": "تأكيد",
      "Public Tracking Portal": "بوابة التتبع العامة",
      "Console Sign In": "تسجيل الدخول للمنصة",
      "Shipment Reference": "مرجع الشحنة",
      "Transport Mode": "طريقة النقل",
      "Cargo Load": "حمولة الشحنة",
      "Real-Time Tracking Status": "حالة التتبع اللحظية",
      "Shipment Not Found": "لم يتم العثور على الشحنة",
      "The shipment reference or ID is invalid or has been removed.": "مرجع الشحنة أو الرقم التعريفي غير صحيح أو تم إزالته.",
      "Go to Console": "الانتقال للمنصة",
      "Open public tracking page": "فتح صفحة التتبع العامة",
      "Top Performers Leaderboard": "قائمة الموظفين الأكثر نشاطاً",
      "Team Contributions Today": "مساهمات الفريق اليوم",
      "No activity today": "لا توجد نشاطات اليوم",
      "actions": "عمليات",
      "hrs": "ساعة",
      ...
      "Purchasing": "الشراء",
      "Accounting": "المحاسبة",
      "AR · AP · cash · P&L": "الذمم المدينة · الدائنة · النقد · الأرباح والخسائر",
      "Price offers": "عروض الأسعار",
      "Download Client Guide (PDF)": "تنزيل دليل العملاء (PDF)",
      "Track Your Shipment": "تتبع شحنتك الان",
      "Enter your shipment reference number below to track in real-time.": "أدخل رقم مرجع الشحنة أدناه للتتبع اللحظي.",
      "Track": "تتبع",
      "Please enter a shipment reference.": "يرجى أدخال مرجع الشحنة.",
      "VAT (KDV) Rate": "نسبة الضريبة",
      "VAT (KDV) Amount": "مبلغ الضريبة",
      "Subtotal (Matrah)": "المجموع (قبل الضريبة)",
      "Grand Total": "الإجمالي الشامل للضريبة",
      "VAT Summary": "ملخص الضريبة",
      "Calculated VAT (Sales)": "الضريبة المحسوبة (المبيعات)",
      "Deductible VAT (Purchases)": "الضريبة القابلة للخصم (المشتريات)",
      "Net VAT Payable": "صافي الضريبة المستحقة للدفع",
      "Net VAT Receivable": "صافي الضريبة المستردة",
      "Performance Metrics": "مؤشرات الأداء",
      "Compensation & Raises": "الرواتب والزيادات",
      "My Recent Activity": "نشاطاتي الأخيرة",
      "No activity logged yet.": "لم يتم تسجيل نشاطات بعد.",
      "month": "شهر",
      "General": "عام",
      "Company Financial Statement": "التقرير المالي للشركة",
      "Export PDF": "تصدير PDF",
      "Export Excel": "تصدير Excel",
      "Metric": "المعيار",
      "Value (USD)": "القيمة (دولار)",
      "Details": "التفاصيل",
      "Sales orders": "طلبات المبيعات",
      "Procurement & bills": "المشتريات والفواتير",
      "Performance": "الأداء",
      "Salary": "الراتب",
      "Raise Recommendation": "توصية زيادة الراتب",
      "Consistency": "الاستمرارية",
      "Revenue Impact": "الأثر على الإيرادات",
      "Suggested Raise": "الزيادة المقترحة",
      "Log Raise": "تسجيل زيادة راتب",
      "active days": "أيام نشطة",
      "AI Raise Recommendation": "توصية الذكاء الاصطناعي للزيادة",
      "Performance Improvement Plan": "خطة تحسين الأداء",
      "Team rank": "ترتيب الفريق",
      "Seniority": "الأقدمية",
      "Active days (30d)": "الأيام النشطة (30 يوم)",
      "Actions (30d)": "العمليات (30 يوم)",
      "All-time actions": "إجمالي العمليات",
      "Improving": "في تحسن",
      "Declining": "في تراجع",
      "Stable": "مستقر",
      "No performance data yet.": "لا توجد بيانات أداء بعد.",
      "Current salary": "الراتب الحالي",
      "Log a raise": "تسجيل زيادة",
      "Raise %": "نسبة الزيادة %",
      "Raise history": "سجل الزيادات",
      "Date": "التاريخ",
      "Raise": "الزيادة",
      "No raise history yet": "لا يوجد سجل زيادات بعد",
      "Profile": "الملف الشخصي",
      "Salary & Raise": "الراتب والزيادة",
      "Name, email and password are required": "الاسم والبريد الإلكتروني وكلمة المرور مطلوبة",
      "Raise logged": "تم تسجيل الزيادة",
      "Account updated": "تم تحديث الحساب",
      "Account created": "تم إنشاء الحساب",
      "You can't delete your own account": "لا يمكنك حذف حسابك الخاص",
      "Voice replies on": "الردود الصوتية مفعلة",
      "Voice replies off": "الردود الصوتية معطلة",
      "Voice input is not supported in this browser": "الإدخال الصوتي غير مدعوم في هذا المتصفح",
      "Ask anything": "إسأل عن أي شيء",
      "Speak": "تحدث",
      "Read replies aloud": "قراءة الردود بصوت عالٍ",
      "Send": "إرسال",
      "Reconnecting…": "جاري إعادة الاتصال…",
      "Accept & create order": "قبول وإنشاء طلب",
      "Add at least one item": "أضف عنصراً واحداً على الأقل",
      "Add item": "إضافة عنصر",
      "Bill": "فاتورة شراء",
      "Category": "الفئة",
      "Cost": "التكلفة",
      "Costs & margin": "التكاليف وهامش الربح",
      "Create purchase order": "إنشاء أمر شراء",
      "Create quote": "إنشاء عرض سعر",
      "Demo data restored": "تم استعادة البيانات التجريبية",
      ...
      "Türkçe": "Türkçe",
      "العربية": "العربية",
      "8 industries you choose from": "8 صناعات تختار من بينها",
      "Explore ": "استكشف ",
      "Logistics & Trade": "اللوجستيات والتجارة",
      "freight": "شحن",
      "Freight, customs and fleet — tracked end to end.": "الشحن والجمارك والأسطول — متتبع من البداية للنهاية.",
      "Freight, fully tracked.": "شحن متتبع بالكامل.",
      "Container 20ft": "حاوية 20 قدم",
      "Pallet Ship": "شحن بالمنصة",
      "Express Air": "شحن جوي سريع",
      "Fashion & Apparel": "الموضة والأزياء",
      "atelier": "مشغل",
      "Collections, sizes and seasons that sell themselves.": "تشكيلات ومقاسات ومواسم تبيع نفسها بنفسها.",
      "New season, now live.": "الموسم الجديد متاح الآن.",
      "Linen Blazer": "سترة كتان",
      "Silk Dress": "فستان حرير",
      "Suede Boots": "حذاء شمواه",
      "Wholesale & Distribution": "البيع بالجملة والتوزيع",
      "depot": "مستودع",
      "Bulk orders, price tiers and B2B — handled with ease.": "طلبات الجملة وفئات الأسعار — تتم بسهولة.",
      "Bulk, priced to move.": "بالجملة، بأسعار تنافسية.",
      "Rice 25kg": "أرز 25 كجم",
      "Sugar 50kg": "سكر 50 كجم",
      "Flour Pallet": "منصة دقيق",
      "Retail Superstore": "سوبر ماركت التجزئة",
      "market": "سوق",
      "Aisles of stock, one live shelf count.": "ممرات من المخزون، جرد مباشر للرفوف.",
      "Everything, in stock.": "كل شيء متوفر بالمخزون.",
      "Cola 6-pack": "كولا 6 عبوات",
      "Olive Oil 1L": "زيت زيتون 1 لتر",
      "Detergent": "منظف",
      "Manufacturing": "التصنيع",
      "works": "مصنع",
      "Raw parts to finished product, right on schedule.": "من المواد الخام إلى المنتج النهائي، في الوقت المحدد.",
      "Parts to product.": "من أجزاء إلى منتج.",
      "Bearing Set": "مجموعة رولمان بلي",
      "Alloy Sheet": "لوح سبائك",
      "Motor Unit": "وحدة محرك",
      "Restaurant": "مطعم",
      "bistro": "بيسترو",
      "Menu, kitchen and tables in one smooth flow.": "قائمة الطعام والمطبخ والطاولات في تدفق سلس واحد.",
      "Order fresh, served fast.": "اطلب طازجاً، يقدم سريعاً.",
      "Margherita": "مارغريتا",
      "Beef Burger": "برجر لحم",
      "Garden Salad": "سلطة خضراء",
      "Construction": "البناء",
      "buildco": "شركة بناء",
      "Sites, materials and crews — all accounted for.": "المواقع والمواد والفرق — كلها محسوبة.",
      "Materials, on schedule.": "المواد في الموعد المحدد.",
      "Cement 50kg": "أسمنت 50 كجم",
      "Steel Pipe": "أنبوب صلب",
      "Power Drill": "شنيور",
      "Professional Services": "الخدمات المهنية",
      "studio": "استوديو",
      "Book, bill and deliver every engagement.": "احجز، فوتر، وسلم كل مهمة.",
      "Book, bill, deliver.": "احجز، فوتر، سلم.",
      "Consulting hr": "ساعة استشارة",
      "Design Package": "باقة تصميم",
      "Retainer": "توكيل شهري",
      "demo.souqi.site": "demo.souqi.site",
      "building…": "يتم البناء…",
      "Watch your website build itself…": "شاهد موقعك وهو يُبنى بنفسه…",
      "demo": "تجريبي",
      "Cart": "عربة",
      ...
      "Pay with": "الدفع عبر",
      "Pay $260": "دفع ٢٦٠$",
      "Creating your site…": "جاري إنشاء موقعك…",
      "✓ Site created": "✓ تم إنشاء الموقع",
      "Applying the Retail template…": "جاري تطبيق قالب التجزئة…",
      "✓ Template applied": "✓ تم تطبيق القالب",
      "Adding products…": "جاري إضافة المنتجات…",
      "✓ 3 products added": "✓ تمت إضافة ٣ منتجات",
      "Editing the hero text…": "جاري تعديل النص الرئيسي…",
      "✓ Hero updated": "✓ تم تحديث النص",
      "Switching theme → teal…": "جاري تغيير المظهر → أزرق مخضر…",
      "✓ Theme changed": "✓ تم تغيير المظهر",
      "Publishing…": "جاري النشر…",
      "Cart · 2": "عربة · ٢",
      "live": "مباشر",
      "✓ Published — live now": "✓ تم النشر — مباشر الآن",
      "A customer is checking out…": "عميل يقوم بالدفع…",
      "✓ Paid": "✓ تم الدفع",
      "✓ Order paid · Visa •••• 4242": "✓ تم دفع الطلب · فيزا •••• ٤٢٤٢",
      "Built with Souqi": "تم الإنشاء بواسطة سوقي",

      /* ---- build.html (prompt-first home) ---- */
      "Orders, stock, finance, shipments": "الطلبات والمخزون والمالية والشحنات",
      "Storefront builder": "منشئ المتجر",
      "Click anything to edit it": "انقر على أي عنصر لتعديله",
      "AI assistant": "المساعد الذكي",
      "Ask your data in plain language": "اسأل بياناتك بلغة بسيطة",
      "Retail & Fashion": "التجزئة والأزياء",
      "Restaurants & Services": "المطاعم والخدمات",
      "Agent": "الوكيل",
      "What will you build?": "ماذا ستبني؟",
      "Describe your business in one sentence. Your first build is free — no card needed.": "صِف عملك في جملة واحدة. أول إنشاء مجاني — بدون بطاقة.",
      "Start": "ابدأ",
      "Website": "موقع إلكتروني",
      "Storefront": "متجر",
      "Catalog": "كتالوج",
      "Booking": "حجوزات",
      "Landing": "صفحة تعريفية",
      "Try an example prompt": "جرّب مثالاً جاهزاً",
      "Built for": "مصمم لـ",
      "Meet the <em>Souqi Agent</em>": "تعرّف على <em>وكيل سوقي</em>",
      "Your business, running on one sentence.": "عملك كله يبدأ بجملة واحدة.",
      "Live editor": "محرر مباشر",
      "Design Freely": "صمّم بحرية",
      "Click any section, heading, price or photo and change it right on the page. What you see is exactly what your customers get.": "انقر على أي قسم أو عنوان أو سعر أو صورة وغيّره مباشرة على الصفحة. ما تراه هو تماماً ما يراه عملاؤك.",
      "Staged builds": "إنشاء على مراحل",
      "Move faster": "تقدّم أسرع",
      "The Agent plans, writes and assembles your pages in parallel — and shows you every step as it happens.": "يخطط الوكيل ويكتب ويجمع صفحاتك بالتوازي — ويعرض لك كل خطوة لحظة حدوثها.",
      "One workspace": "مساحة عمل واحدة",
      "Ship Anything": "أطلق أي شيء",
      "Storefront, catalog, orders, invoices and shipments in one project — with one design and no context switching.": "المتجر والكتالوج والطلبات والفواتير والشحنات في مشروع واحد — بتصميم واحد ودون تشتت.",
      "Roles & permissions": "الأدوار والصلاحيات",
      "Build together": "ابنوا معاً",
      "Invite your team with the right role — owner, manager, staff. Everyone works on the same live data, and every change is on the audit trail.": "ادعُ فريقك بالدور المناسب — مالك، مدير، موظف. الجميع يعمل على نفس البيانات الحية، وكل تغيير مسجّل في سجل التدقيق.",
      "Powered by the Souqi platform": "مدعوم بمنصة سوقي",
      "Agent chat": "محادثة الوكيل",
      "Describe It.<br>Publish It.": "صِفه.<br>انشُره.",
      "Describe your business and publish it. The Agent builds a real storefront, keeps improving it, and stays out of your way.": "صِف عملك وانشره. يبني الوكيل متجراً حقيقياً، ويطوّره باستمرار، ولا يقف في طريقك.",
      "Full-stack infrastructure": "بنية تحتية متكاملة",
      "Build & Scale<br>Your Store.": "ابنِ متجرك<br>ووسّعه.",
      "Built-in from day one — accounts, your own database, hosting, and a full audit log. No servers to wire up.": "جاهز من اليوم الأول — حسابات، وقاعدة بياناتك الخاصة، واستضافة، وسجل تدقيق كامل. لا خوادم لإعدادها.",
      "Integrations": "التكاملات",
      "Connect To AI<br>& Services.": "اتصل بالذكاء<br>الاصطناعي والخدمات.",
      "Payments, QR checkout, WhatsApp orders and a Gemini-powered assistant that answers questions about your own data.": "مدفوعات، ودفع عبر رمز QR، وطلبات واتساب، ومساعد مدعوم بـ Gemini يجيب عن أسئلتك حول بياناتك.",
      "Control": "التحكم",
      "Secure Your Data<br>As You Scale.": "أمّن بياناتك<br>مع نموّك.",
      "Per-workspace isolation, hashed passwords, signed sessions and role-based access. Your data never mixes with anyone else's.": "عزل لكل مساحة عمل، وكلمات مرور مشفّرة، وجلسات موقّعة، وصلاحيات حسب الدور. بياناتك لا تختلط ببيانات أحد.",
      "Trusted by builders": "يثق به البناة",
      "Sample quotes — replace before launch": "آراء تجريبية — استبدلها قبل الإطلاق",
      "Next<br>testimonial": "الرأي<br>التالي",
      "Previous<br>testimonial": "الرأي<br>السابق",
  ...
  function initLanguageControls() {
    ...
    document.querySelectorAll(".lang-dropdown").forEach((dd) => {
      ...
      if (currentSpan) {
        currentSpan.textContent = currentLang === "ar" ? "العربية" : (currentLang === "tr" ? "Türkçe" : "English");
      }
  ...
  return { icon, money, usd, toUSD, num, date, dateTime, rel, initials, flag, esc, avColor, toast, modal, closeModal, drawer, closeDrawer, confirm, getLang, setLang, applyLanguage, t, translatePage };
})();
