...
/* ---------------- Auth ---------------- */
/* window.Auth used to live here: a demo-mode sign-in that kept a session
   object in localStorage and drove the old SAP console. Every dependency it
   had — Store, Workspace, INDUSTRIES — has been deleted with the storefront
   product, and its last caller went with them. Real sign-in is login.html
   posting to /auth/login, which replies with an httpOnly sq_session cookie
   that nothing in a browser has to hold.

   What remains below is window.UI: the translator and language switcher,
   which home.html and login.html both still use. */
