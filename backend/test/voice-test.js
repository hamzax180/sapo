/* Drives frontend/js/voice-input.js against a fake SpeechRecognition, so the
...
function loadModule(env) {
  const src = fs.readFileSync(path.join(__dirname, "..", "..", "frontend", "js", "voice-input.js"), "utf8");
