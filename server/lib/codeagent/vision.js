/* =================================================================
   vision.js — looking at a photo someone attached
   -----------------------------------------------------------------
   The build model cannot see. Both routes in this deployment point at
   deepseek-chat, and dom-snapshot.js exists because of exactly that: it
...
module.exports = { describe, available, PROMPT, MAX_BYTES, TIMEOUT_MS };
